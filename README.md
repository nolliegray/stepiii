...
_Shortcut:_  
Holding **[J]** and pressing an increment button will change all tracks to match the current value.
...
_Shortcut:_  
Holding a page **[N]** and pressing another page will copy the step data to the other page.
...
_Shortcut:_ 
Holding **[O]** and pressing a column sets all tracks to that step length.  
Holding **[O]** and pressing a page button **[N]** (1–4) will set the track length for all tracks to either 16, 32, 48, or 64 steps.
...
_Shortcut:_  
Holding **[R]** or **[S]** and pressing an existing step will cycle through options of that step without removing it.
...
_Shortcut:_  
Holding **[X]** and pressing a mute or a preset will toggle all mutes or presets in a column.
...
_Shortcut:_  
You can save or load a whole column of presets by holding the **[X]** button while selecting a preset from a column of **[BB]**.
